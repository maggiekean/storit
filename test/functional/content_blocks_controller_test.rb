...
class ContentBlocksControllerTest < ActionController::TestCase
  ...
  test "should create content_block" do
    assert_difference('ContentBlock.count') do
      post :create, content_block: { content: @content_block.content, intenger: @content_block.intenger, user_id: @content_block.user_id }
    end
  ...
  test "should update content_block" do
    put :update, id: @content_block, content_block: { content: @content_block.content, intenger: @content_block.intenger, user_id: @content_block.user_id }
    assert_redirected_to content_block_path(assigns(:content_block))
  end
